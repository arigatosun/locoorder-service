    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-[#121212] rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="mb-6 border-b border-gray-100 dark:border-gray-800 pb-4">
              ...
              <h3 className="text-xl font-bold">初期設定サポート</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
              導入時のメニュー登録や設定をサポート。お客様の負担を最小限に抑え、スムーズな立ち上げをお手伝いします。
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#121212] rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="mb-6 border-b border-gray-100 dark:border-gray-800 pb-4">
              ...
              <h3 className="text-xl font-bold">運用サポート</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
              サーバー監視やバージョンアップ対応など安心の保守体制を整えています。システムの安定稼働を24時間365日見守ります。
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#121212] rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="mb-6 border-b border-gray-100 dark:border-gray-800 pb-4">
              ...
              <h3 className="text-xl font-bold">問い合わせ窓口</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
              導入後も安心の専任サポート体制。お電話やメールでのお問い合わせに、経験豊富なスタッフが迅速に対応いたします。
            </p>
          </div>
        </div>
        
        <div className="mt-16 bg-gradient-to-r from-[#fff8e6] to-[#fffcf2] dark:from-[#1a1302] dark:to-[#121008] rounded-xl p-8 shadow-md">
